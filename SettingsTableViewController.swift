...
class SettingsTableViewController: UITableViewController {
    ...
    let accountSettings: [String] = ["Logout"]
    let legalSettings: [String] = ["Terms and Conditions", "Privacy Policy"]
...
//        cell.backgroundColor = UIColor(red:1.00, green:1.00, blue:1.00, alpha:0.1)
//        cell.textLabel?.textColor = .white
        if indexPath.section == 0 {
            cell.textLabel?.text = legalSettings[indexPath.row]
